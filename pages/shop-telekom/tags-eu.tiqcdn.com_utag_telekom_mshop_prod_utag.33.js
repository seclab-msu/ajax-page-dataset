...
//tealium universal tag - utag.sender.23012 ut4.0.202112151514, Copyright 2021 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {"id" : id};
...
function(a,b,c,d,e,f,g){if(1){d=b['js_page.utag.cfg.path'];if(typeof d=='undefined')return;c=[{'/dev/':'423493631852538'},{'/qa/':'283019532657179'}];var m=false;for(e=0;e<c.length;e++){for(f in utag.loader.GV(c[e])){if(d.toString().indexOf(f)>-1){b['wt_track_id']=c[e][f];m=true};};if(m)break};if(!m)b['wt_track_id']='283019532657179';   }},
    ...
    u.send = function(a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.data = {
          ...
          "product_unit_price" : [],
          "product_discount" : [],
          "wt_object_name" : "wt_15" || "wt",
          "wt_config" :{
            "trackId" : "283019532657179",
